...
data_directory = '/mnt/DataGuillaume/LMN/A1408/A1408-190408'
# data_directory = '/mnt/DataGuillaume/LMN/A1407/A1407-190403'
...
for i in spikes:
	...
	# subplot(5,6,i+1)
	# tmp = tuning_curves[1][i] / mean_frate.loc[i,'wake']
	plot(tuning_curves[1][i], label = str(shank[i]))
	# plot(tmp, label = str(shank[i]))
	legend()
