...
# A TUNING CURVES
####################################################################
gs_left = gridspec.GridSpecFromSubplotSpec(6,4, subplot_spec = gs_top[0,0], hspace = 0.1, wspace = 0.1)#, width_ratios = [0.1, 0.5, 0.5, 0.5], height_ratios = [0.2, 0.8], hspace = 0)
...
savefig("/home/guillaume/Dropbox (Peyrache Lab)/Talks/2021-II/fig_ipn_2_5.png", dpi = 200, facecolor = 'white')
