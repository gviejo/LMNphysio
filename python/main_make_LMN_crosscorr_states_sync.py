...
for s in datasets:
# for s in ['LMN/A1411/A1411-200908A']:	
	print(s)
	name = s.split('/')[-1]
	...
	cc_sws = compute_AsyncCrossCorrs(spikes, sws_ep, 2, 2000, norm=True, edge = 20)
...
cPickle.dump(datatosave, open(os.path.join('../figures/figures_ipn_2020', 'All_crosscor_async.pickle'), 'wb'))
