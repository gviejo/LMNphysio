...
data_directory = '/mnt/DataGuillaume/Dhruv/A8504/A8504-210708A'
...
wake_ep2 = splitWake(wake_ep)
for j in range(2):
	spatial_curves, extent				= computePlaceFields(spikes, position[['x', 'z']], wake_ep2.loc[[j]], 15)
