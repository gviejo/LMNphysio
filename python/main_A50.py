...
data_directory = '/mnt/DataGuillaume/LMN-ADN/A5001/A5001-200210B'
...
cc = compute_CrossCorrs(spikes, wake_ep, 10, 4000, norm = False)
cc = cc.rolling(window=500, win_type='gaussian', center= True, min_periods=1).mean(std = 5.0)
...
# 	subplot(6,6,i+1)
# 	plot(cc[c], label = str(shank[c[0]])+' '+str(shank[c[1]]))
# 	title(c)
# 	legend()
# show()
