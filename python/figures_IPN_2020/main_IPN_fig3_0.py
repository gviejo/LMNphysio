...
# outergs = GridSpec(2,2, figure = fig, width_ratios = [0.25, 0.75], wspace = 0.3)


####################################################################
# A TUNING CURVES
####################################################################
# gs_left = gridspec.GridSpecFromSubplotSpec(4,8, subplot_spec = outergs[0,1])#, width_ratios = [0.1, 0.5, 0.5, 0.5], height_ratios = [0.2, 0.8], hspace = 0)
gs_left = GridSpec(4,4, figure = fig, hspace = 0.15)#, width_ratios = [0.25, 0.75], wspace = 0.3)
...
gs_left.update(top= 0.98, bottom = 0.07, right = 0.97, left = 0.02)

savefig("/home/guillaume/Dropbox (Peyrache Lab)/Talks/2020-IPN/fig_ipn_3_0.png", dpi = 200, facecolor = 'white')