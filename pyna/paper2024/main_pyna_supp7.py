...
outergs = GridSpec(1, 1, hspace = 0.4)
...
gs_bottom = gridspec.GridSpecFromSubplotSpec(
    2, 1, subplot_spec=outergs[0,0], hspace=0.4
    )
...
outergs.update(top=0.92, bottom=0.09, right=0.99, left=0.1)


savefig(
    os.path.expanduser("~") + "/Dropbox/LMNphysio/paper2024/supp7.pdf",
    dpi=200,
    facecolor="white",
)
# show()
