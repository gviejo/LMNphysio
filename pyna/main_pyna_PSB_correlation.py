...
# @Last Modified time: 2023-02-23 17:09:48
...
datasets = np.genfromtxt('/mnt/DataRAID2/datasets_PSB.list', delimiter = '\n', dtype = str, comments = '#')
...
cPickle.dump(datatosave, open(os.path.join('/home/guillaume/Dropbox/CosyneData', 'All_correlation_PSB.pickle'), 'wb'))
