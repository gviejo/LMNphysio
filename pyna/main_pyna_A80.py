...
# @Last Modified time: 2023-03-01 16:50:01
import scipy.io
import sys, os
import numpy as np
import pandas as pd
...
path = '/mnt/Data2/Opto/A8000/A8045/A8045-230301A'
...
peth = nap.compute_perievent(spikes, nap.Ts(opto_ep["start"].values), minmax=(-3, 13))
...
wake2_ep = wake_ep.set_diff(opto_ep.merge_close_intervals(10.0))
